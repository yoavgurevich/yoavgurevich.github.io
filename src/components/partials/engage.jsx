                ...
                <div className={this.props.currentBg == 'indianred' || this.state.hasAnimated ? 'grid-content' : 'grid-content col-1'}>
                    ...
                    {this.props.currentBg == 'indianred' || this.state.hasAnimated ? (
                        <div className='fade-in'>
                            <a className='img-link' href='https://www.engagepeople.com/podium.html' rel='noopener noreferrer' target='_blank'><img src={PodiumLogo} alt='Podium Logo'></img></a>
                            <a className='img-link' href='https://www.engagepeople.com/lrg.html' rel='noopener noreferrer' target='_blank'><img src={LrgLogo} alt='LRG Logo'></img></a>
                            <p>
                                Spending time on two of the loyalty powerhouse's flagship products Podium & Access (LRG)
